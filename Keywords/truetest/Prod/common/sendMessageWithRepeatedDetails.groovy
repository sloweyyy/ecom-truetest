...
public class sendMessageWithRepeatedDetails {
    
    private static def execute(String input_emailAddress, String input_fullName, String select_subject, String textarea_message, String textarea_message_1) {
        ...
        "Step 7: Enter input value in textarea message"
